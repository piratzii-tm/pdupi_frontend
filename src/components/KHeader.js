  ...
  return trainer ? (
    <div className={"flex flex-col"}>
      ...
      <text className={"text-white text-xl font-mohave"}>
        ...
        Gym <text className={"text-barberry"}>Fit</text>!Fie că ți-ai propus să
        pierzi în greutate în timp record, să-ți recapeți energia sau să ai un
        tonus mai bun, alături de un antrenor personal ești cu un pas mai
        aproape de a-ți atinge obiectivele de fitness, pentru că vă fi lângă
        tine pe tot parcursul călătoriei tale!
      </text>
    </div>
  ) : client ? (
    <div className={"flex flex-col"}>
